...
interface HeroFormWorkingProps {
  data: HeroContent;
  onChange: (data: HeroContent) => void;
}

export function HeroFormWorking({ data, onChange }: HeroFormWorkingProps) {
      ...
      <Card className="border-green-200 bg-green-50">
        <CardHeader>
          ...
          <CardDescription className="text-green-700">
            See how your hero section will appear on the live site
          </CardDescription>
        </CardHeader>
        <CardContent>
