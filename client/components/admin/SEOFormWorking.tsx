...
interface SEOFormWorkingProps {
  data: SEOSettings;
  onChange: (data: SEOSettings) => void;
}

export function SEOFormWorking({ data, onChange }: SEOFormWorkingProps) {
      ...
      <Card className="border-green-200 bg-green-50">
        <CardHeader>
          ...
          <CardDescription className="text-green-700">
            Current SEO settings summary
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border">
              <h4 className="font-medium text-sm mb-2">Meta Information</h4>
            ...
            <div className="bg-white rounded-lg p-4 border">
              <h4 className="font-medium text-sm mb-2">SEO Score</h4>
              <div className="space-y-2">
