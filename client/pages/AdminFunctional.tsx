          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Edit the main headline, subtitle, and key messaging</CardDescription>
              </CardHeader>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateData('hero', { ...data.hero, heroImage: e.target.value })}
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Add, edit, and manage product features</CardDescription>
              </CardHeader>
                  ...
                  <div key={feature.id} className="p-4 border rounded-lg space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Label htmlFor={`feature-${feature.id}-enabled`}>Enabled</Label>
                        <Switch
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor={`feature-${feature.id}-icon`}>Icon</Label>
                        <Input
                ...
                {data.testimonials.map((testimonial, index) => (
                  <div key={testimonial.id} className="p-4 border rounded-lg space-y-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor={`testimonial-${testimonial.id}-name`}>Customer Name</Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor={`testimonial-${testimonial.id}-rating`}>Rating (1-5)</Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor={`testimonial-${testimonial.id}-location`}>Location</Label>
                        <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor={`testimonial-${testimonial.id}-review`}>Review Text</Label>
                      <Textarea
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    {data.seo.metaTitle.length}/60 characters (recommended: 50-60)
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-500">
                    {data.seo.metaDescription.length}/160 characters (recommended: 150-160)
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateData('seo', { ...data.seo, ogImage: e.target.value })}
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Preview how your changes will appear on the live site</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-white rounded-lg p-6 border shadow-sm">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <span className="text-2xl font-bold text-green-600">${data.hero.salePrice}</span>
                    {data.hero.originalPrice && (
                      <span className="text-lg text-gray-500 line-through">${data.hero.originalPrice}</span>
                    )}
                  </div>
                  <div className="flex gap-3 mb-6">
                    <Button className="flex-1">{data.hero.primaryButtonText}</Button>
                    <Button variant="outline" className="flex-1">{data.hero.secondaryButtonText}</Button>
                  </div>
                  
                  <div className="border-t pt-4">
                    <h3 className="font-medium mb-2">Features ({data.features.filter(f => f.enabled).length} active):</h3>
                    <div className="grid md:grid-cols-2 gap-2">
                      {data.features.filter(f => f.enabled).slice(0, 4).map(feature => (
