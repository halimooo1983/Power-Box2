...
const sidebarItems = [
  ...
  },
  {
    ...
    label: "Features",
    icon: Settings,
    description: "Manage feature points",
  },
  {
  ...
  },
  {
    ...
    label: "SEO Settings",
    icon: Search,
    description: "Meta titles, descriptions",
  },
  {
  ...
  {
    id: "rating" as AdminSection,
    label: "Rating Display",
    icon: Star,
    description: "Configure star ratings",
  },
  {
    id: "popups" as AdminSection,
    label: "Popups & Modals",
    icon: MessageSquare,
    description: "Exit intent popups",
  },
  {
    id: "preview" as AdminSection,
    label: "Preview",
    icon: Eye,
        ...
        <main className="p-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your landing page content for the{" "}
                {sidebarItems.find((item) => item.id === activeSection)?.label}{" "}
                section
              </CardDescription>
            </CardHeader>
