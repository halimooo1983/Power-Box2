...
export const defaultLandingPageData: LandingPageData = {
  hero: {
    ...
    heroImage: "https://cdn.builder.io/api/v1/image/assets%2F84282e2d620247d2b8d8845fda2c790e%2F79d471e5bc56457eb2c3b1c3eb6586ae?format=webp&width=800",
    heroImageAlt: "Nutritious Snack Box with Breakfast Bars and Delicious Chips - 42 Count",
  ...
  testimonials: [
    {
      ...
      name: "Sarah Johnson",
      rating: 5,
      review: "Amazing variety of snacks! Perfect for our office break room. Everyone loves them!",
      profileImage: "https://images.unsplash.com/photo-1494790108755-2616c65ce15a?w=150&h=150&fit=crop&crop=face",
      verified: true,
    ...
    },
    {
      ...
      name: "Mike Chen",
      rating: 5,
      review: "Great gift idea! My college-aged daughter absolutely loved this care package.",
    ...
    },
    {
      ...
      rating: 4,
      review: "Good quality snacks and beautiful packaging. Arrived quickly and in perfect condition.",
  ...
  seo: {
    metaTitle: "Nutritious Snack Box - 42 Count Gift Pack | Premium Breakfast Bars & Chips",
    metaDescription: "Premium 42-count snack box with breakfast bars and delicious chips. Perfect gift for all ages with beautiful packaging and greeting card included.",
    ogImage: "https://cdn.builder.io/api/v1/image/assets%2F84282e2d620247d2b8d8845fda2c790e%2F79d471e5bc56457eb2c3b1c3eb6586ae?format=webp&width=1200",
    ogImageAlt: "Nutritious Snack Box - 42 Count Gift Pack",
    keywords: ["snack box", "gift", "breakfast bars", "healthy snacks", "42 count", "care package"],
  ...
  popups: [
    {
      ...
      description: "Join our newsletter and receive exclusive deals on premium snack boxes.",
